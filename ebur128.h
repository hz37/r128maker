// Modified by Hens Zimmerman, March 29-03-2011.
// Renamed SLIST_ENTRY to SLIST_ENTRY2
// because Windows platform SDK already has a SLIST_ENTRY
...
struct ebur128_dq_entry {
  double z;
  SLIST_ENTRY2(ebur128_dq_entry) entries;
};
/** @endcond */
